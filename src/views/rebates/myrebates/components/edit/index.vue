        ...
        <el-tabs v-model="activeName" type="card">
            ...
            <el-tab-pane label="返点设置" name="second">        
                <div class="bgColor" style="background-color: #EEF1F6;border: 1px solid #dfe6ec;border-bottom:none;">
                    <el-button style="margin:20px 0px 20px 20px" @click="addGoodsType" :disabled="isable">增加</el-button>
                    <el-table style="border:none;" :data="personConfig">
                        <el-table-column align="center" label="等级" min-width="150">           
                            <template scope="scope">
                                <el-select placeholder="请选择" v-model="scope.row.customerGradeID">
                                    <el-option
                        ...
                        <el-table-column align="center" label="操作" min-width="150">
                            <template scope="scope">
                                <el-button @click="delGoodsType(scope.$index, scope.row.distributorPersonItemID)">删除</el-button>
                            </template>                    
                        </el-table-column>
                    </el-table>  
                </div> 
